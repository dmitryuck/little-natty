package
{
	...
	public class Main extends Sprite 
	{
		...
		public static function gameOver():void
		{
			...
			completeWnd.addComponent(new Position(387, 154), "txt_time", new Text(timeMin.toString() + " : " + timeSec.toString(), txtStyle));
		...
		public static function levelCompleted():void
		{
			...
			{			
				...
				completeWnd.addComponent(new Position(387, 154), "txt_time", new Text(timeMin.toString(), txtStyle));
				completeWnd.addComponent(new Position(387, 216), "txt_step", new Text(usedSteps.toString(), txtStyle));
		...
		{
			if (selectedFruit1) selectedFruit1.removeChildObject(selectedFruit1.getChildObjectByName("ramka"));
			selectedFruit1 = null;
		}
		...
		{
			if (selectedFruit2) selectedFruit2.removeChildObject(selectedFruit2.getChildObjectByName("ramka"));
			selectedFruit2 = null;
		}
