package user 
{
	 ...
	 * @author Monkgol
	 */
	public class DialogCrab2 extends Window 
	{
		public var currentReplic:int = 0;
		public var xmlDialog:XML;
		
		public var dlgFile:String = "dialog_crab_2";
		
		
		public function DialogCrab2(name:String, fileName:String) 
		{
			super(name, fileName);
		...
		override protected function onCreate(e:ComponentEvent):void 
		{
			...
			hideComponent(addComponent(new Position(296, 144), "nattyImg", new Image("graphics/interface/dialog_1.swf")));
			hideComponent(addComponent(new Position(488, 18), "friendImg", new Image("graphics/interface/dialog_1.swf")));
			
			addComponent(new Position(332, 178), "nattyReplic", new Text("", Main.dialogTextStyle));
			addComponent(new Position(524, 51), "friendReplic", new Text("", Main.dialogTextStyle));
		...
		{
			Scene5(Game.scene).canComplete = true;
		...
		override protected function onClick(e:MouseEvent):void 
		{
			...
			if (currentReplic == 4) this.setSource("graphics/comix/vipustil_craba.swf");
