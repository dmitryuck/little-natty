package game.core 
{
	...
	public class Scene extends Sprite	
	{
		...
		// Испольщуются преимущественно в режиме EDIT
		public var selectedObjects:Vector.<GameObject>;
		...
		{			
			...
			if (source.fileName) loadScene(source.fileName); else dispatchEvent(new SceneEvent(SceneEvent.SCENE_LOADED));
		}
		...
		public function loadScene(fileName:String):void
		{
			...
			var xmlScene:XML = new XML(source.getSource());
		...
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		// Создать префаб
		public function addPrefab(type:String = "",
												   fileName:String = "",
												   name:String = "",
												   tag:String = ""):Prefab
		{
