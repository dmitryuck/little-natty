package editor {
	...
	{		
		...
		public function TransformEvent(type:String, targetObject:DisplayObject, x:Number = 0, y:Number = 0, rotation:Number = 0, scale:Number = 0, bubbles:Boolean = false, cancelable:Boolean = false)
		{
