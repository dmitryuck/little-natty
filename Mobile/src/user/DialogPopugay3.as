package user 
{
	 ...
	 * @author Monkgol
	 */
	public class DialogPopugay3 extends Window 
	{
		public var currentReplic:int = 0;
		public var xmlDialog:XML;
		
		public var dlgFile:String = "dialog_popugay_3";
		
		
		public function DialogPopugay3(name:String, fileName:String) 
		{
			super(name, fileName);
		...
		{
			Scene20(Game.scene).canComplete = true;
