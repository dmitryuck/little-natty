package user 
{
	 ...
	 * @author Monkgol
	 */
	public class DialogSlizen3 extends Window 
	{
		public var currentReplic:int = 0;
		public var xmlDialog:XML;
		
		public var dlgFile:String = "dialog_slizen_3";
		
		
		public function DialogSlizen3(name:String, fileName:String) 
		{
			super(name, fileName);
		...
		override protected function onCreate(e:ComponentEvent):void 
		{
			...
			hideComponent(addComponent(new Position(120, 82), "nattyImg", new Image("graphics/interface/dialog_1.swf")));
			hideComponent(addComponent(new Position(254, 10), "friendImg", new Image("graphics/interface/dialog_1.swf")));
			
			addComponent(new Position(159, 119), "nattyReplic", new Text("", Main.dialogTextStyle));
			addComponent(new Position(293, 45), "friendReplic", new Text("", Main.dialogTextStyle));
		...
		{
			Scene12(Game.scene).canComplete = true;
