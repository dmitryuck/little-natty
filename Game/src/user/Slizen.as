package user
{
	 ...
	 * @author Monkgol
	 */
	public class Slizen extends GameObject
	{		
		public var animTimer:Timer;
		
		
		public function Slizen(fileName:String, name:String, tag:String) 
		{
		...
		public static function showDialog():void
		{
			...
			if (Game.scene.getCurrentScene() == "level_8")
			{
				Game.loadWindow(new Position(0, 0), "dialog", DialogSlizen1, "graphics/comix/vstrecha_so_sliznem.swf");				
			}
			
			if (Game.scene.getCurrentScene() == "level_10")
			{
				Game.loadWindow(new Position(0, 0), "dialog", DialogSlizen2, "graphics/comix/vstrecha_so_sliznem_2.swf");				
			}
			
			if (Game.scene.getCurrentScene() == "level_12")
			{
				Game.loadWindow(new Position(0, 0), "dialog", DialogSlizen3, "graphics/comix/vstrecha_so_sliznem_3.swf");				
			}
		}
