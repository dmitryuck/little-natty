package user 
{
	 ...
	 * @author Monkgol
	 */
	public class DialogCrab1 extends Window 
	{
		public var currentReplic:int = 0;
		public var xmlDialog:XML;
		
		public var dlgFile:String = "dialog_crab_1";
		
		
		public function DialogCrab1(name:String, fileName:String) 
		{
			super(name, fileName);
		...
		override protected function onCreate(e:ComponentEvent):void 
		{
			...
			hideComponent(addComponent(new Position(250, 142), "nattyImg", new Image("graphics/interface/dialog_1.swf")));
			hideComponent(addComponent(new Position(462, 21), "friendImg", new Image("graphics/interface/dialog_1.swf")));
			
			addComponent(new Position(286, 176), "nattyReplic", new Text("", Main.dialogTextStyle));
			addComponent(new Position(500, 60), "friendReplic", new Text("", Main.dialogTextStyle));
		...
		public function endDialog():void
		{
			...
			Scene3(Game.scene).canComplete = true;
